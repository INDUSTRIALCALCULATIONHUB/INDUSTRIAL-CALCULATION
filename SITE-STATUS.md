...
| Existing calculator interface and knowledge-module upgrade | In progress | 1 of 11 | `air-density.html` is the first staged update. Its existing inputs, validation, formula and output remain unchanged; the page now uses the approved responsive portal layout, a scoped original illustration and a calculator-specific engineering-knowledge module that links to the canonical Air Density guide. |
