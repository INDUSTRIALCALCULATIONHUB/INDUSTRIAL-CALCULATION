...
| Sitewide search | Implemented | 71 indexed pages; 39 header controls | Client-side search covers the published page catalogue across knowledge pages, tools, converters and current domain pages. Every visible portal-header search control opens the shared search page; inactive Fabrication BOM Creator is excluded. |
