...
| Responsive visual design system | Implemented for current portal pages | 64 | The owner-selected boxed blue-and-copper portal design is implemented on Home, five support pages, four Level 1 domain pages, 34 Level 2 landing pages, 17 Level 3 navigation pages, one Level 4 navigation page, the first final knowledge page and the search page. The shared stylesheet includes a visible mobile search field. |
