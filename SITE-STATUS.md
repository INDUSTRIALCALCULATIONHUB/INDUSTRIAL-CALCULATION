...
| Level 2 landing pages | 20 published; 8 prepared for owner approval | 28 of 34 | All eleven Engineering and all nine Industrial Equipment Level 2 groups are live. Power Generation Processes; Cement Manufacturing Process; Steel Manufacturing Process; Chemical and Petrochemical Processes; Water and Wastewater Treatment Processes; Air Pollution Control Processes; Bulk Material Handling Processes; and Industrial Utility Processes are locally verified as the next eight Level 2 pages, each with its frozen Level 3 groups and an original illustration. |
