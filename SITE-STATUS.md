...
| Existing calculator interface and knowledge-module upgrade | In progress | 6 of 11 | `air-density.html`, `duct-flow-calculator.html`, `duct-weight.html`, `plate-weight.html`, `flange-weight.html` and `hopper-valley-angle-calculator.html` use the approved responsive portal layout, original page-specific illustrations and calculator-specific engineering-knowledge modules. Their existing inputs, validation, formulas and outputs remain unchanged. |
