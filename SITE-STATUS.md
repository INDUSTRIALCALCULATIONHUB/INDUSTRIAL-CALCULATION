...
| Published knowledge pages | Final page-format rewrite and formal format/source review complete | 249 | All two hundred and forty-nine published knowledge pages now use the frozen final knowledge-page template: canonical metadata, five-level context, information strip, table of contents, original page-specific content, FAQs, published related links, book references, review information and disclaimer. The seven batch reviews under `outputs/` record the page-format, source and link checks. This is editorial, format and source governance—not independent qualified-engineer sign-off. |
...
| New knowledge pages from frozen hierarchy | Engineering and Industrial Equipment complete; Industrial Processes first 50 complete | 249 | All 102 Engineering and all 97 Industrial Equipment knowledge records are published. The first 50 of 55 Industrial Processes knowledge records are now published in the frozen final format and retain their canonical URLs. Independent qualified-engineer review remains required before project use. |
...
| Sitewide search and sitemap | Expanded | 429 sitemap URLs |  Client-side search now includes every Level 3 navigation route, and the sitemap includes the four Level 1 pages, 34 Level 2 pages and 125 Level 3 pages. Inactive Fabrication BOM Creator remains excluded. |
