...
| Primary-domain landing pages | Implemented | 4 of 4 | `engineering.html`, `industrial-equipment.html`, `industrial-processes.html` and `engineering-reference-data.html` expose the approved Level 2 groups; all currently constructed Engineering and Industrial Equipment Level 2 routes are linked from their Level 1 pages. |
| Level 2 landing pages | 11 published; 9 prepared for owner approval | 20 of 34 | All eleven Engineering Level 2 groups are live. Boilers, Steam and Combustion Equipment; Pumps, Fans, Blowers and Compressors; Heat Exchangers, Cooling Systems and Vessels; Conveying Systems; Feeders, Gates, Valves, Dampers and Airlocks; Air Pollution Control Equipment; Electrical and Instrumentation Equipment; Structural Steel, Supports and Access Equipment; and Water and Wastewater Equipment are locally verified as the next nine Level 2 pages, each with its frozen Level 3 groups and an original illustration. |
