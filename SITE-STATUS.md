...
| Sitewide search and sitemap | Expanded | 379 sitemap URLs |  Client-side search now includes every Level 3 navigation route, and the sitemap includes the four Level 1 pages, 34 Level 2 pages and 125 Level 3 pages. Inactive Fabrication BOM Creator remains excluded. |
