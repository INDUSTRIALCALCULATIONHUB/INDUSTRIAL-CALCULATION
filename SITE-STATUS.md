...
| Published knowledge pages | Final page-format rewrite and formal format/source review complete | 300 | All three hundred published knowledge pages now use the frozen final knowledge-page template: canonical metadata, five-level context, information strip, table of contents, original page-specific content, FAQs, published related links, book references, review information and disclaimer. The nine batch reviews under `outputs/` record the page-format, source and link checks. This is editorial, format and source governance—not independent qualified-engineer sign-off. |
...
| New knowledge pages from frozen hierarchy | All four primary domains complete | 300 | All 102 Engineering, all 97 Industrial Equipment, all 55 Industrial Processes and all 46 Engineering Reference Data knowledge records are now published in the frozen final format. Reference-data pages are source-governed guides; numerical tables require separate source, edition and verifier approval before publication. Independent qualified-engineer review remains required before project use. |
| New reference-data records | Final-format source-governed guides published | 46 of 46 | All controlled Engineering Reference Data guides are live. Numerical tables remain withheld until source, edition, scope, unit and independent-verifier controls are approved. |
...
| Sitewide search and sitemap | Expanded | 480 sitemap URLs |  Client-side search now includes every Level 3 navigation route, and the sitemap includes the four Level 1 pages, 34 Level 2 pages and 125 Level 3 pages. Inactive Fabrication BOM Creator remains excluded. |
