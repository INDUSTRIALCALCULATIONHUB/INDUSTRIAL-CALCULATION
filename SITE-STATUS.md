...
| Primary-domain landing pages | Implemented | 4 of 4 | `engineering.html`, `industrial-equipment.html`, `industrial-processes.html` and `engineering-reference-data.html` expose the approved Level 2 groups; all currently constructed Engineering, Industrial Equipment and Industrial Processes Level 2 routes are linked from their Level 1 pages. |
| Level 2 landing pages | Published | 28 of 34 | All eleven Engineering, all nine Industrial Equipment and all eight Industrial Processes Level 2 groups are live. Each of the eight Industrial Processes pages has its frozen Level 3 groups and an original illustration. |
...
| Responsive visual design system | Implemented for current portal pages | 39 | The owner-selected boxed blue-and-copper portal design is implemented on Home, five support pages, four Level 1 domain pages, 28 Level 2 landing pages and the search page. The shared stylesheet includes a visible mobile search field. |
| Sitewide search | Implemented | 71 indexed pages; 39 header controls | Client-side search covers the published page catalogue across knowledge pages, tools, converters and current domain pages. Every visible portal-header search control opens the shared search page; the mobile search field is visible without opening the navigation menu; inactive Fabrication BOM Creator is excluded. |
